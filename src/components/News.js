  ...
  render() {
    ...
    return (
      ...
      {/* // <div className='container my-3' style={{ color: this.props.mode === `light` ? 'black ' : 'white', backgroundColor: this.props.mode === `light` ? 'white ' : '#263238' }}> */}
        <h1 className='text-center' style={{ margin: '40px',color: this.props.mode === `light` ? 'black ' : 'white' }}>{`NewsMonkey - Top ${this.capitalizeFirstLetter(this.props.category)} Headlines`}</h1>
